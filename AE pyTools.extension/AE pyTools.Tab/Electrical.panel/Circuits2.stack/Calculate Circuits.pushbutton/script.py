...
def main():
    ...
    try:
        ...
        for branch in branches:
            ...
            notice_lines.append("* **{}**".format(branch.name))
            for category, levels in branch.notices.categorized():
                ...
                if cat_msgs:
                    notice_lines.append("  * {}:".format(cat_label))
                    notice_lines.extend(cat_msgs)
